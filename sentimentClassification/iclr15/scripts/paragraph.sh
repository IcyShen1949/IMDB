...
cat ../data/subdata/full-train-pos.txt ../data/subdata/full-train-neg.txt ../data/subdata/test-pos.txt ../data/subdata/test-neg.txt ../data/subdata/train-unsup.txt > alldata.txt
